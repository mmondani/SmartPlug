...
La presente memoria describe el diseño de un controlador inteligente de dispositivos eléctricos que puede ser conectado a cualquier tomacorriente, y permite controlar y conocer el consumo eléctrico desde su teléfono móvil. Se realizó con el objetivo de incorporar un innovador equipo de fabricación nacional a la línea de productos de domótica ofrecidos por la empresa X-28 Alarmas. 

La principal motivación para diseñar el producto surgió de la creciente preocupación relacionada con el consumo eléctrico y sus costos en constante aumento.
